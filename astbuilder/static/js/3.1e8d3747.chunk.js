(this["webpackJsonpkudyakov_diplom"] = this["webpackJsonpkudyakov_diplom"] || []).push([[3],{
...
module.exports=function(){return new Worker(__webpack_require__.p+"f12205017548e6c4d571.worker.js");};
...
var regenerator = __webpack_require__(219);
...
// CONCATENATED MODULE: ./src/containers/InputWindow.js
function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);if(enumerableOnly)symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable;});keys.push.apply(keys,symbols);}return keys;}function _objectSpread(target){for(var i=1;i<arguments.length;i++){var source=arguments[i]!=null?arguments[i]:{};if(i%2){ownKeys(source,true).forEach(function(key){Object(defineProperty["a" /* default */])(target,key,source[key]);});}else if(Object.getOwnPropertyDescriptors){Object.defineProperties(target,Object.getOwnPropertyDescriptors(source));}else{ownKeys(source).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key));});}}return target;}var DEFAULT_TIMEOUT=200;var InputWindow_InputWindow=function InputWindow(_ref){var options=_ref.options,input=_ref.input,lang=_ref.lang,theme=_ref.theme,file=_ref.file,startParsing=_ref.startParsing,updateInput=_ref.updateInput,updateOutput=_ref.updateOutput,updateOutputType=_ref.updateOutputType;var _useState=Object(react["useState"])(null),_useState2=_slicedToArray(_useState,2),timer=_useState2[0],setTimer=_useState2[1];var handleChange=/*#__PURE__*/function(){var _ref2=_asyncToGenerator(/*#__PURE__*/regenerator_default.a.mark(function _callee(newValue){return regenerator_default.a.wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:startParsing();Object(startParserWorker["a" /* default */])({input:newValue,lang:lang,options:options[lang]},function(e){var output=e.data;updateOutput(output);});case 2:case"end":return _context.stop();}}},_callee);}));return function handleChange(_x){return _ref2.apply(this,arguments);};}();Object(react["useEffect"])(function(){startParsing();Object(startParserWorker["a" /* default */])({input:input[lang],lang:lang,options:options[lang]},function(e){var output=e.data;updateOutput(output);updateOutputType('json');});// eslint-disable-next-line
},[]);return react_default.a.createElement("div",{className:input.isLoading?'input loading':'input'},react_default.a.createElement(lib_default.a,{language:lang,theme:theme,value:input[lang],options:file?_objectSpread({},editors["a" /* inputEditorOptions */],{readOnly:true}):_objectSpread({},editors["a" /* inputEditorOptions */],{readOnly:false}),onChange:function onChange(newValue){updateInput(newValue,lang);clearTimeout(timer);setTimer(setTimeout(function(){return handleChange(newValue);},DEFAULT_TIMEOUT));},editorDidMount:function editorDidMount(editor){window.addEventListener('resize',function(){return editor.layout();});editor.focus();}}));};var mapStateToProps=function mapStateToProps(_ref3){var options=_ref3.options,input=_ref3.input,lang=_ref3.lang,theme=_ref3.theme,file=_ref3.file;return{options:options,input:input,lang:lang,theme:theme,file:file};};var InputWindow_mapDispatchToProps=function mapDispatchToProps(dispatch){return{startParsing:Object(redux["a" /* bindActionCreators */])(actions["c" /* startParsing */],dispatch),updateInput:Object(redux["a" /* bindActionCreators */])(actions["d" /* updateInput */],dispatch),updateOutput:Object(redux["a" /* bindActionCreators */])(actions["g" /* updateOutput */],dispatch),updateOutputType:Object(redux["a" /* bindActionCreators */])(actions["h" /* updateOutputType */],dispatch)};};/* harmony default export */ var containers_InputWindow = __webpack_exports__["default"] = (Object(es["b" /* connect */])(mapStateToProps,InputWindow_mapDispatchToProps)(InputWindow_InputWindow));

/***/ })

}]);
//# sourceMappingURL=3.1e8d3747.chunk.js.map