...
/******/ 		return __webpack_require__.p + "static/js/" + ({}[chunkId]||chunkId) + "." + {"0":"5b805a04","1":"739c7599","3":"9a01610b","4":"4353527c","5":"67e07301","6":"2f4e1b66","7":"508ee104","8":"1747c9aa","9":"25ed51c8","10":"bd538e86"}[chunkId] + ".chunk.js"
/******/ 	}
/******/
...
/******/ 				var href = "static/css/" + ({}[chunkId]||chunkId) + "." + {"0":"e4b6ee68","1":"31d6cfe0","3":"31d6cfe0","4":"31d6cfe0","5":"31d6cfe0","6":"31d6cfe0","7":"31d6cfe0","8":"31d6cfe0","9":"31d6cfe0","10":"31d6cfe0"}[chunkId] + ".chunk.css";
...
/******/
/******/ 	var jsonpArray = this["webpackJsonpkudyakov_diplom"] = this["webpackJsonpkudyakov_diplom"] || [];
...
/* harmony import */ var symbol_observable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(10);
...
// CONCATENATED MODULE: ./src/helpers/defaultPrograms.js
var defaultPrograms={javascript:'const a = [1, true, () => {}]',php:'<?php\n'+'// Комментарий\n'+'function sum($a, $b) {\n'+'    return $a + $b;\n'+'}\n'+'/* Блочный\n'+'Комментарий */\n'+'$num1 = 2;\n'+'$num2 = 3;\n'+'sum($num1, $num2);\n'+'?>',c:'#include <stdio.h>\n'+' \n'+'int main()\n'+'{\n'+'  printf("Hello World\\n");\n'+'  return 0;\n'+'}',java:'import java.util;\n'+'class HelloWorld {\n'+'    public static void main(String[] args) {\n'+'        System.out.println("Hello World!");\n'+'    }\n'+'}'};/* harmony default export */ var helpers_defaultPrograms = (defaultPrograms);
// CONCATENATED MODULE: ./src/helpers/defaultOptions.js
var defaultOptions={javascript:{retainLines:true},java:{retainLines:true},c:{retainLines:true},php:{retainLines:true},xml:{},json:{}};/* harmony default export */ var helpers_defaultOptions = (defaultOptions);
// CONCATENATED MODULE: ./src/helpers/preloadedState.js
function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);if(enumerableOnly)symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable;});keys.push.apply(keys,symbols);}return keys;}function _objectSpread(target){for(var i=1;i<arguments.length;i++){var source=arguments[i]!=null?arguments[i]:{};if(i%2){ownKeys(source,true).forEach(function(key){Object(defineProperty["a" /* default */])(target,key,source[key]);});}else if(Object.getOwnPropertyDescriptors){Object.defineProperties(target,Object.getOwnPropertyDescriptors(source));}else{ownKeys(source).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key));});}}return target;}var version=1.75;var options=_objectSpread({},helpers_defaultOptions);var input=_objectSpread({},helpers_defaultPrograms);var lang='javascript';var theme='vs-dark';var output={json:'Loading...',xml:'Loading...'};var outputType='json';var file=null;/* harmony default export */ var preloadedState = __webpack_exports__["a"] = ({version:version,options:options,input:input,lang:lang,theme:theme,output:output,outputType:outputType,file:file});
...
var objectWithoutPropertiesLoose = __webpack_require__(1);
...
var react_is = __webpack_require__(8);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(11), __webpack_require__(25)(module)))
...
var bootstrap = __webpack_require__(26);

// EXTERNAL MODULE: ./src/styles/App.css
var styles_App = __webpack_require__(27);

// EXTERNAL MODULE: ./src/styles/MenuBar.css
var MenuBar = __webpack_require__(28);

// EXTERNAL MODULE: ./src/styles/Editors.css
var Editors = __webpack_require__(29);

// CONCATENATED MODULE: ./src/components/App.js
var App_MenuBar=Object(react["lazy"])(function(){return __webpack_require__.e(/* import() */ 4).then(__webpack_require__.bind(null, 339));});var InputWindow=Object(react["lazy"])(function(){return Promise.all(/* import() */[__webpack_require__.e(0), __webpack_require__.e(3)]).then(__webpack_require__.bind(null, 340));});var OutputWindow=Object(react["lazy"])(function(){return Promise.all(/* import() */[__webpack_require__.e(0), __webpack_require__.e(5)]).then(__webpack_require__.bind(null, 341));});var App_App=function App(){return react_default.a.createElement("div",{className:"app"},react_default.a.createElement(react["Suspense"],{fallback:react_default.a.createElement("div",{className:"loader"})},react_default.a.createElement(App_MenuBar,null),react_default.a.createElement("div",{className:"editors"},react_default.a.createElement(InputWindow,null),react_default.a.createElement(OutputWindow,null))));};/* harmony default export */ var components_App = (App_App);
// EXTERNAL MODULE: ./node_modules/@babel/runtime/helpers/esm/defineProperty.js
var defineProperty = __webpack_require__(3);

// CONCATENATED MODULE: ./src/reducers/index.js
function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);if(enumerableOnly)symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable;});keys.push.apply(keys,symbols);}return keys;}function _objectSpread(target){for(var i=1;i<arguments.length;i++){var source=arguments[i]!=null?arguments[i]:{};if(i%2){ownKeys(source,true).forEach(function(key){Object(defineProperty["a" /* default */])(target,key,source[key]);});}else if(Object.getOwnPropertyDescriptors){Object.defineProperties(target,Object.getOwnPropertyDescriptors(source));}else{ownKeys(source).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key));});}}return target;}var reducers_reducer=function reducer(){var state=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};var action=arguments.length>1?arguments[1]:undefined;switch(action.type){case'UPDATE_OPTIONS':return _objectSpread({},state,{options:_objectSpread({},state.options,Object(defineProperty["a" /* default */])({},action.payload.lang,action.payload.options))});case'UPDATE_INPUT':if(action.payload.lang){return _objectSpread({},state,{input:_objectSpread({},state.input,Object(defineProperty["a" /* default */])({},action.payload.lang,action.payload.value))});}else{return _objectSpread({},state,{input:action.payload.value});}case'UPDATE_LANG':return _objectSpread({},state,{lang:action.payload});case'UPDATE_THEME':return _objectSpread({},state,{theme:action.payload});case'START_PARSING':return _objectSpread({},state,{output:_objectSpread({},state.output,{isLoading:true})});case'UPDATE_OUTPUT':return _objectSpread({},state,{output:_objectSpread({},action.payload,{isLoading:false})});case'UPDATE_OUTPUT_TYPE':return _objectSpread({},state,{outputType:action.payload});case'LOAD_FILE':return _objectSpread({},state,{file:action.payload});case'CLOSE_FILE':return _objectSpread({},state,{file:null});default:return state;}};/* harmony default export */ var reducers = (reducers_reducer);
// EXTERNAL MODULE: ./node_modules/@babel/runtime/helpers/esm/objectWithoutPropertiesLoose.js
var objectWithoutPropertiesLoose = __webpack_require__(1);
...
function localStorage_ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);if(enumerableOnly)symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable;});keys.push.apply(keys,symbols);}return keys;}function localStorage_objectSpread(target){for(var i=1;i<arguments.length;i++){var source=arguments[i]!=null?arguments[i]:{};if(i%2){localStorage_ownKeys(source,true).forEach(function(key){Object(defineProperty["a" /* default */])(target,key,source[key]);});}else if(Object.getOwnPropertyDescriptors){Object.defineProperties(target,Object.getOwnPropertyDescriptors(source));}else{localStorage_ownKeys(source).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key));});}}return target;}var localStorage_loadState=function loadState(){try{var serializedState=window.localStorage.getItem('state');if(serializedState===null){return preloadedState["a" /* default */];}var json=JSON.parse(serializedState);var version=json.version;if(!version||version<preloadedState["a" /* default */].version){return preloadedState["a" /* default */];}return localStorage_objectSpread({},json,{output:{json:'Loading...',xml:'Loading...'},outputType:'json'});}catch(e){return undefined;}};var localStorage_saveState=function saveState(state){try{var file=state.file,output=state.output,outputType=state.outputType,props=_objectWithoutProperties(state,["file","output","outputType"]);var serializedState=JSON.stringify(props);if(!file)window.localStorage.setItem('state',serializedState);}catch(e){return undefined;}};
// CONCATENATED MODULE: ./src/index.js
var persistedState=localStorage_loadState();var store=Object(redux["b" /* createStore */])(reducers,persistedState,window.__REDUX_DEVTOOLS_EXTENSION__&&window.__REDUX_DEVTOOLS_EXTENSION__());store.subscribe(Object(lodash["throttle"])(function(){localStorage_saveState(store.getState());},1000));react_dom_default.a.render(react_default.a.createElement(es["a" /* Provider */],{store:store},react_default.a.createElement(components_App,null)),document.getElementById('root'));

/***/ })
/******/ ]);
//# sourceMappingURL=main.30b824ea.js.map