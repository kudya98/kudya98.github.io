(this["webpackJsonpkudyakov_diplom"] = this["webpackJsonpkudyakov_diplom"] || []).push([[7],{
...
// CONCATENATED MODULE: ./node_modules/monaco-editor/esm/vs/basic-languages/javascript/javascript.js
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "conf", function() { return javascript_conf; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "language", function() { return javascript_language; });
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
var javascript_monaco = typeof monaco === 'undefined' ? self.monaco : monaco;

var javascript_conf = conf;
var javascript_language = {
  // Set defaultToken to invalid to see what you do not tokenize yet
  defaultToken: 'invalid',
  tokenPostfix: '.js',
...
//# sourceMappingURL=7.508ee104.chunk.js.map