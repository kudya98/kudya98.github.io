...
"use strict";
/* WEBPACK VAR INJECTION */(function(process) {/* unused harmony export setUriThrowOnMissingScheme */
...
function _validateUri(ret, _strict) {
  ...
  if (!ret.scheme) {
    ...
    } else {// console.warn(`[UriError]: Scheme is missing: {scheme: "", authority: "${ret.authority}", path: "${ret.path}", query: "${ret.query}", fragment: "${ret.fragment}"}`);
    }
...
module.exports = function () {
  return new Worker(__webpack_require__.p + "fe31aa4d6ef59302b745.worker.js");
};
...
// EXTERNAL MODULE: ./node_modules/monaco-editor/esm/vs/editor/editor.worker.js
var editor_worker = __webpack_require__(1);

// CONCATENATED MODULE: ./node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/_deps/vscode-languageserver-types/main.js
/* --------------------------------------------------------------------------------------------
 * Copyright (c) Microsoft Corporation. All rights reserved.
 * Licensed under the MIT License. See License.txt in the project root for license information.
 * ------------------------------------------------------------------------------------------ */
...
function withFormatting(text, edit, formattingOptions) {
  ...
  var edits = format_format(newText, {
    offset: begin,
    length: end - begin
...
var formats = {
  'color-hex': {
    errorMessage: jsonParser_localize('colorHexFormatWarning', 'Invalid color format. Use #RGB, #RGBA, #RRGGBB or #RRGGBBAA.'),
    pattern: /^#([0-9A-Fa-f]{3,4}|([0-9A-Fa-f]{2}){3,4})$/
  },
  'date-time': {
    errorMessage: jsonParser_localize('dateTimeFormatWarning', 'String is not a RFC3339 date-time.'),
    pattern: /^(\d{4})-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])T([01][0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9]|60)(\.[0-9]+)?(Z|(\+|-)([01][0-9]|2[0-3]):([0-5][0-9]))$/i
  },
  'date': {
    errorMessage: jsonParser_localize('dateFormatWarning', 'String is not a RFC3339 date.'),
    pattern: /^(\d{4})-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])$/i
  },
  'time': {
    errorMessage: jsonParser_localize('timeFormatWarning', 'String is not a RFC3339 time.'),
    pattern: /^([01][0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9]|60)(\.[0-9]+)?(Z|(\+|-)([01][0-9]|2[0-3]):([0-5][0-9]))$/i
  },
  'email': {
    errorMessage: jsonParser_localize('emailFormatWarning', 'String is not an e-mail address.'),
...
var jsonParser_ValidationResult =
/** @class */
function () {
    ...
    if (!this.enumValueMatch && !validationResult.enumValueMatch && this.enumValues && validationResult.enumValues) {
      ...
      for (var _i = 0, _a = this.problems; _i < _a.length; _i++) {
        ...
        if (error.code === ErrorCode.EnumValueMismatch) {
          error.message = jsonParser_localize('enumWarning', 'Value is not accepted. Valid values: {0}.', this.enumValues.map(function (v) {
    ...
    if (Array.isArray(schema.enum)) {
      ...
      if (!enumValueMatch) {
        validationResult.problems.push({
          ...
          message: schema.errorMessage || jsonParser_localize('enumWarning', 'Value is not accepted. Valid values: {0}.', schema.enum.map(function (v) {
            return JSON.stringify(v);
          }).join(', '))
        });
      }
...
function jsonParser_parse(textDocument, config) {
  ...
  function _parseArray(parent) {
    ...
    /* EOF */
      ...
      if (!item) {
        _error(jsonParser_localize('PropertyExpected', 'Value expected'), ErrorCode.ValueExpected, null, [], [4
        /* CloseBracketToken */
        , 5
        /* CommaToken */
        ]);
  ...
  function _parseProperty(parent, keysSeen) {
    ...
    if (!value) {
      return _error(jsonParser_localize('ValueExpected', 'Value expected'), ErrorCode.ValueExpected, node, [], [2
      /* CloseBraceToken */
      , 5
      /* CommaToken */
      ]);
  ...
  function _parseObject(parent) {
    ...
    /* EOF */
      ...
      if (!property) {
        _error(jsonParser_localize('PropertyExpected', 'Property expected'), ErrorCode.PropertyExpected, null, [], [2
        /* CloseBraceToken */
        , 5
        /* CommaToken */
        ]);
...
var jsonCompletion_JSONCompletion =
/** @class */
function () {
...
var vscode_uri = __webpack_require__(0);
...
var jsonSchemaService_FilePatternAssociation =
/** @class */
function () {
...
var jsonSchemaService_ResolvedSchema =
/** @class */
function () {
...
var jsonSchemaService_JSONSchemaService =
/** @class */
function () {
  ...
  JSONSchemaService.prototype.getRegisteredSchemaIds = function (filter) {
    return Object.keys(this.registeredSchemasIds).filter(function (id) {
      var scheme = vscode_uri["a" /* URI */].parse(id).scheme;
  ...
  JSONSchemaService.prototype.normalizeId = function (id) {
    ...
    try {
      return vscode_uri["a" /* URI */].parse(id).toString();
    } catch (e) {
      return id;
    }
  };
  ...
  JSONSchemaService.prototype.resolveSchemaContent = function (schemaToResolve, schemaURL, dependencies) {
    ...
    return resolveRefs(schema, schema, schemaURL, dependencies).then(function (_) {
      return new jsonSchemaService_ResolvedSchema(schema, resolveErrors);
    });
  };
...
function toDisplayString(url) {
  try {
    var uri = vscode_uri["a" /* URI */].parse(url);
...
var jsonValidation_JSONValidation =
/** @class */
function () {
...
var jsonDocumentSymbols_JSONDocumentSymbols =
/** @class */
function () {
  ...
  JSONDocumentSymbols.prototype.findDocumentSymbols2 = function (document, doc) {
    ...
    var collectOutlineEntries = function collectOutlineEntries(result, node) {
      if (node.type === 'array') {
...
function getLanguageService(params) {
  ...
  return {
    ...
    parseJSONDocument: function parseJSONDocument(document) {
      return jsonParser_parse(document, {
        collectComments: true
      });
    },
    newJSONDocument: function newJSONDocument(root, diagnostics) {
      return jsonParser_newJSONDocument(root, diagnostics);
    },
    doResolve: jsonCompletion.doResolve.bind(jsonCompletion),
    doComplete: jsonCompletion.doComplete.bind(jsonCompletion),
    findDocumentSymbols: jsonDocumentSymbols.findDocumentSymbols.bind(jsonDocumentSymbols),
    findDocumentSymbols2: jsonDocumentSymbols.findDocumentSymbols2.bind(jsonDocumentSymbols),
    findColorSymbols: function findColorSymbols(d, s) {
...
(function (Range) {
  function create(one, two, three, four) {
    if (main_Is.number(one) && main_Is.number(two) && main_Is.number(three) && main_Is.number(four)) {
      return {
        start: main_Position.create(one, two),
        end: main_Position.create(three, four)
      };
  ...
  function is(value) {
    var candidate = value;
    return main_Is.objectLiteral(candidate) && main_Position.is(candidate.start) && main_Position.is(candidate.end);
  }
...
(function (Location) {
  ...
  function is(value) {
    var candidate = value;
    return main_Is.defined(candidate) && main_Range.is(candidate.range) && (main_Is.string(candidate.uri) || main_Is.undefined(candidate.uri));
  }
...
(function (LocationLink) {
  ...
  function is(value) {
    var candidate = value;
    return main_Is.defined(candidate) && main_Range.is(candidate.targetRange) && main_Is.string(candidate.targetUri) && (main_Range.is(candidate.targetSelectionRange) || main_Is.undefined(candidate.targetSelectionRange)) && (main_Range.is(candidate.originSelectionRange) || main_Is.undefined(candidate.originSelectionRange));
  }

  LocationLink.is = is;
})(main_LocationLink || (main_LocationLink = {}));
/**
 * The Color namespace provides helper functions to work with
 * [Color](#Color) literals.
 */
...
(function (Color) {
  ...
  function is(value) {
    var candidate = value;
    return main_Is.number(candidate.red) && main_Is.number(candidate.green) && main_Is.number(candidate.blue) && main_Is.number(candidate.alpha);
  }
...
(function (ColorInformation) {
  ...
  function is(value) {
    var candidate = value;
    return main_Range.is(candidate.range) && main_Color.is(candidate.color);
  }
...
(function (ColorPresentation) {
  ...
  function is(value) {
    var candidate = value;
    return main_Is.string(candidate.label) && (main_Is.undefined(candidate.textEdit) || main_TextEdit.is(candidate)) && (main_Is.undefined(candidate.additionalTextEdits) || main_Is.typedArray(candidate.additionalTextEdits, main_TextEdit.is));
  }
...
(function (FoldingRange) {
  ...
  function is(value) {
    var candidate = value;
    return main_Is.number(candidate.startLine) && main_Is.number(candidate.startLine) && (main_Is.undefined(candidate.startCharacter) || main_Is.number(candidate.startCharacter)) && (main_Is.undefined(candidate.endCharacter) || main_Is.number(candidate.endCharacter)) && (main_Is.undefined(candidate.kind) || main_Is.string(candidate.kind));
  }
...
(function (Diagnostic) {
  ...
  function is(value) {
    var candidate = value;
    return main_Is.defined(candidate) && main_Range.is(candidate.range) && main_Is.string(candidate.message) && (main_Is.number(candidate.severity) || main_Is.undefined(candidate.severity)) && (main_Is.number(candidate.code) || main_Is.string(candidate.code) || main_Is.undefined(candidate.code)) && (main_Is.string(candidate.source) || main_Is.undefined(candidate.source)) && (main_Is.undefined(candidate.relatedInformation) || main_Is.typedArray(candidate.relatedInformation, main_DiagnosticRelatedInformation.is));
  }
...
(function (TextEdit) {
  ...
  function is(value) {
    var candidate = value;
    return main_Is.objectLiteral(candidate) && main_Is.string(candidate.newText) && main_Range.is(candidate.range);
  }
...
(function (TextDocumentEdit) {
  ...
  function is(value) {
    var candidate = value;
    return main_Is.defined(candidate) && main_VersionedTextDocumentIdentifier.is(candidate.textDocument) && Array.isArray(candidate.edits);
  }
...
(function (CreateFile) {
  ...
  function is(value) {
    var candidate = value;
    return candidate && candidate.kind === 'create' && main_Is.string(candidate.uri) && (candidate.options === void 0 || (candidate.options.overwrite === void 0 || main_Is.boolean(candidate.options.overwrite)) && (candidate.options.ignoreIfExists === void 0 || main_Is.boolean(candidate.options.ignoreIfExists)));
  }

  CreateFile.is = is;
})(main_CreateFile || (main_CreateFile = {}));
...
(function (RenameFile) {
  ...
  function is(value) {
    var candidate = value;
    return candidate && candidate.kind === 'rename' && main_Is.string(candidate.oldUri) && main_Is.string(candidate.newUri) && (candidate.options === void 0 || (candidate.options.overwrite === void 0 || main_Is.boolean(candidate.options.overwrite)) && (candidate.options.ignoreIfExists === void 0 || main_Is.boolean(candidate.options.ignoreIfExists)));
  }

  RenameFile.is = is;
})(main_RenameFile || (main_RenameFile = {}));
...
(function (DeleteFile) {
  ...
  function is(value) {
    var candidate = value;
    return candidate && candidate.kind === 'delete' && main_Is.string(candidate.uri) && (candidate.options === void 0 || (candidate.options.recursive === void 0 || main_Is.boolean(candidate.options.recursive)) && (candidate.options.ignoreIfNotExists === void 0 || main_Is.boolean(candidate.options.ignoreIfNotExists)));
  }

  DeleteFile.is = is;
})(main_DeleteFile || (main_DeleteFile = {}));
  ...
  function is(value) {
    ...
    return candidate && (candidate.changes !== void 0 || candidate.documentChanges !== void 0) && (candidate.documentChanges === void 0 || candidate.documentChanges.every(function (change) {
      if (main_Is.string(change.kind)) {
        return main_CreateFile.is(change) || main_RenameFile.is(change) || main_DeleteFile.is(change);
      } else {
...
function () {
  ...
  WorkspaceChange.prototype.createFile = function (uri, options) {
    ...
    this._workspaceEdit.documentChanges.push(main_CreateFile.create(uri, options));
  };

  WorkspaceChange.prototype.renameFile = function (oldUri, newUri, options) {
    this.checkDocumentChanges();

    this._workspaceEdit.documentChanges.push(main_RenameFile.create(oldUri, newUri, options));
  };

  WorkspaceChange.prototype.deleteFile = function (uri, options) {
    this.checkDocumentChanges();

    this._workspaceEdit.documentChanges.push(main_DeleteFile.create(uri, options));
  };
...
(function (Hover) {
  ...
  function is(value) {
    var candidate = value;
    return !!candidate && main_Is.objectLiteral(candidate) && (main_MarkupContent.is(candidate.contents) || main_MarkedString.is(candidate.contents) || main_Is.typedArray(candidate.contents, main_MarkedString.is)) && (value.range === void 0 || main_Range.is(value.range));
  }
...
(function (DocumentSymbol) {
  ...
  function is(value) {
    var candidate = value;
    return candidate && main_Is.string(candidate.name) && main_Is.number(candidate.kind) && main_Range.is(candidate.range) && main_Range.is(candidate.selectionRange) && (candidate.detail === void 0 || main_Is.string(candidate.detail)) && (candidate.deprecated === void 0 || main_Is.boolean(candidate.deprecated)) && (candidate.children === void 0 || Array.isArray(candidate.children));
  }
...
(function (CodeAction) {
  ...
  function is(value) {
    var candidate = value;
    return candidate && main_Is.string(candidate.title) && (candidate.diagnostics === void 0 || main_Is.typedArray(candidate.diagnostics, main_Diagnostic.is)) && (candidate.kind === void 0 || main_Is.string(candidate.kind)) && (candidate.edit !== void 0 || candidate.command !== void 0) && (candidate.command === void 0 || main_Command.is(candidate.command)) && (candidate.edit === void 0 || main_WorkspaceEdit.is(candidate.edit));
  }
...
(function (CodeLens) {
  ...
  function create(range, data) {
    ...
    if (main_Is.defined(data)) result.data = data;
    return result;
  }
  ...
  function is(value) {
    var candidate = value;
    return main_Is.defined(candidate) && main_Range.is(candidate.range) && (main_Is.undefined(candidate.command) || main_Command.is(candidate.command));
  }
...
(function (DocumentLink) {
  ...
  function is(value) {
    var candidate = value;
    return main_Is.defined(candidate) && main_Range.is(candidate.range) && (main_Is.undefined(candidate.target) || main_Is.string(candidate.target));
  }
...
(function (TextDocument) {
  ...
  function is(value) {
    var candidate = value;
    return main_Is.defined(candidate) && main_Is.string(candidate.uri) && (main_Is.undefined(candidate.languageId) || main_Is.string(candidate.languageId)) && main_Is.number(candidate.lineCount) && main_Is.func(candidate.getText) && main_Is.func(candidate.positionAt) && main_Is.func(candidate.offsetAt) ? true : false;
  }
...
var main_TextDocumentSaveReason;
...
(function (TextDocumentSaveReason) {
  ...
  TextDocumentSaveReason.FocusOut = 3;
})(main_TextDocumentSaveReason || (main_TextDocumentSaveReason = {}));

var main_FullTextDocument =
/** @class */
function () {
  function FullTextDocument(uri, languageId, version, content) {
    this._uri = uri;
...
if (typeof fetch !== 'undefined') {
  defaultSchemaRequestService = function defaultSchemaRequestService(url) {
...
self.onmessage = function () {
    ...
    editor_worker["initialize"](function (ctx, createData) {
        return new jsonWorker_JSONWorker(ctx, createData);
    });
};
...
/***/ })
/******/ ]);
//# sourceMappingURL=01c0d76c3492c570f112.worker.js.map